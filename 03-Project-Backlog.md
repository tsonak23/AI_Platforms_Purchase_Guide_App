...
Enable users to securily register in the app 

### User_Story-01:
As a company employee, I want to securily register using company email, so that I can start exploring the platform. 
